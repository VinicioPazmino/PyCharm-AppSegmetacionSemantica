# USAGE
# Ejecutar en la line ade comando para usar las clases (codigo de colores) segun Unity
# python segment_video.py --model enet-cityscapes/enet-model.net --classes enet-cityscapes/enet-classes.txt --colors enet-cityscapes/unity-colors.txt --video videos/AppTFM_RGB77.avi --output output/salidaSemantica.avi
...
while True:
	...
	output = ((0.3 * frame) + (0.9 * mask)).astype("uint8")
